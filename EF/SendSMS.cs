...
namespace LuminousMpartnerIB.EF
{
    ...
    {
        string Connstring = ConfigurationManager.ConnectionStrings["LuminousMpartnerIBEntities"].ConnectionString;
        ...
        public static  LuminousMpartnerIBEntities db;
            ...
            try
            {
               var  mhrCreateOtpResult =  db.Sp_MHrCreateOtp(empid,phoneno);
                if (mhrCreateOtpResult != null)
                {
                    ...
                    //    mailsql m2 = new mailsql(dt.Rows[0][2].ToString(), "not", "not", "LuminousMpartnerIB_mobileApp One Time Password", body, "");
                    //    m2.sendMaildb();
                    //}
                }
                else
