        ...
        public JsonResult GetContactDetail()
        {
            ...
            else
            {
                ...
                if (result[0]["uview"].ToString() == "1")
                {
                    ...
                    //var contactDetails2 = (from c in db.Card_dynamicPage where c.Pagename=="Price"
                    //                       select new
                    //                       {
                    //                           id = c.Id,
                    //                           ParntCat = c.Subcatname,
                    ...
                    //                           Subtitle = c.Sub_Title,
                    //                           StartDate = c.Startdate != null ? Convert.ToDateTime(c.Startdate).ToShortDateString() : "",
                    //                           EndDate = c.Startdate != null ? Convert.ToDateTime(c.Enddate).ToShortDateString() : "",
                    //                           status = c.Status == 1 ? "Active" : "Deactive",
            ...
            else
            {
                ...
                if (result[0]["editrole"].ToString() == "1")
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        db.Card_dynamicPage_History.AddObject(plh);
