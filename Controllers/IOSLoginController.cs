 ...
 <DisID>" + sapcode + @"</DisID>
      ...
      <otp>" + password + @"</otp>
                ...
                using (WebResponse Serviceres = request.GetResponse())
                {
                    ...
                    //Luminous.ServiceReference1.sscMDisCreateOtpRequest abc = new Luminous.ServiceReference1.sscMDisCreateOtpRequest();
        ...
        {
            //Making Web Request    
            HttpWebRequest Req = (HttpWebRequest)WebRequest.Create(@"http://sapservice.luminousindia.com/Lumb2bWebService/service.asmx");
            //SOAPAction    
