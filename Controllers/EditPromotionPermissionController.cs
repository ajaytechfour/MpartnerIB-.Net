...
{
    public class EditPromotionPermissionController : Controller
    {
        //
        ...
        public ActionResult Index(int id)
        {
            ...
            else
            {
                ...
                if (result[0]["editrole"].ToString() == "1")
                {
                  ...
                  List<GetPromotionAccessTable_Result> Pat=  db.GetPromotionAccessTable(id).ToList();
                    return View(Pat);
                }
                else
                {
            ...
            else
            {
                ...
                if (result[0]["editrole"].ToString() == "1")
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        List<ProductAccessTable> patDel = db.ProductAccessTables.Where(a => a.promotionid == id).ToList();
                    ...
                    return Content("<script>alert('Permisson For Has No Value');location.href='../EditPromotionPermission/index/" + id + "';</script>");
                }
                else
                {
                    return RedirectToAction("snotallowed", "snotallowed");
