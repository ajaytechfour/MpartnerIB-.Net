    ...
    public class HomeCardController : Controller
    {
                ...
                if (true)
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        if (Ctype == "8")
                        {
                            ...
                            var update_cardprovidername = db.ExecuteStoreCommand("Update Card_dynamicPage set CardProviderName='" + cardprovidername_id + "' where id='" + parentId + "'");
        ...
        public ActionResult UpdateSequence(string ids)
        {
            ...
            if (bn.CardProviderId == "2")
            {
                ...
                db.ExecuteStoreCommand("Update Card_DynamicPage set sequence='" + seq + "' where id='" + scheme_mainid + "'");
            }
            db.SaveChanges();
