...
{
    public class ProductLevel3ViewController : MultiLanguageController
    {
                        ...
                        if (affectedValue > 0)
                        {
                                ...
                                if (Alls.ToLower() != "on")
                                {
                                    if (rglist != "" && rglist != null)
                                    {
                                        ...
                                        foreach (string s in reglist)
                                        {
                                            ...
                                            db.ProductAccessTableForProducts.Add(pat);
                                            db.SaveChanges();
                            ...
                            if (multiplepostedfiles.Length > 0)
                            {
                                foreach (HttpPostedFileBase Primagemapping in multiplepostedfiles)
                                {
                                    ...
                                    db.ProductthreeImageMappings.Add(Pimagemapping);
                                    if (db.SaveChanges() > 0)
                                    {
            ...
            else
            {
                ...
                if (true)
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        db.ProductLevelThreeHistories.Add(CUDHistory);
