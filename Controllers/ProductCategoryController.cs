...
{
    public class ProductCategoryController : MultiLanguageController
    {
        //
        // GET: /ProductCategory/
              ...
              // //  DataRow[] result = dt.Select("pageurl ='" + pageUrl2 + "'");
                if ( true /*result[0]["createrole"].ToString() == "1"*/)
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        db.ProductCatergories.AddObject(contactusd);
              ...
              // //  DataRow[] result = dt.Select("pageurl ='" + pageUrl2 + "'");
                if ( true /*result[0]["deleterole"].ToString() == "1"*/)
                {
                    ...
                    if (affectedReocrds > 0)
                    {
                        ...
                        db.ProductCatergoryHistories.AddObject(CUDHistory);
                        db.SaveChanges();
